...
### Assignment 5 — Cryptography | FastAPI + HTML/JS
...
**Part 2 — MITM Attack**
Mallory intercepts the channel, generates two fake key pairs, and substitutes
...
The receiver verifies the signature before using the key. Mallory cannot forge
